...
LISTA_NUM_TRACES = (50, 500, 1000, 5000, 10000, 50000, 100000)
LISTA_NUM_TRACES = (50,)
RANGOS_PASOS = (
            ...
            for t_idx in range(num_traces):
                ...
                # --- LÓGICA DE ACTOR BASADA 100% EN PALABRAS CLAVE DEL JSON ---
                    ...
                    if is_wellness or "WELLNESS" in search_target:
                        ...
                        actor = "Pharmacist"
                    elif any(x in search_target for x in ["OBSERVATION", "LAB", "VITAL", "BLOOD", "URINE", "PANEL", "TEST"]):
                        ...
                        actor = "Care_Manager"
                    elif any(x in search_target for x in ["EMERGENCY", "TRIAGE", "ED_VISIT"]):
                        actor = "ER_Staff"
                    elif "DEATH" in search_target:
                        actor = "Medical_Examiner"
                    else:
                        # Solo si no hay ninguna palabra técnica de salud
